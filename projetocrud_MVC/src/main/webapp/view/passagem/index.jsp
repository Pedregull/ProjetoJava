	...
	<table class="table container">
		<thead class="thead-dark">
			<tr>
				...
				<th scope="col">Nome da Passagem</th>
		...
		<tbody>
				...
				<%for (Passagem a : lista) {%>
			
			<tr>
				
			
				<td><%=a.getId_passagem()%></td>
				<td><%=a.getNome_passagem()%></td>
				<td><%=a.getPreco_passagem()%></td>
						
				<td>
					<a class="btn btn-success" href="editar-passagem?id=<%=a.getId_passagem()%>">Atualizar Passagem</a>
					<a class= "btn btn-danger" href="deletar-passagem?id=<%=a.getId_passagem()%>">Deletar Passagem</a>
				</td>
